...
namespace Ust
{
    public partial class FilologieControl : UserControl
    {
        public FilologieControl()
        {
            InitializeComponent();
        ...
        private void bt_cerere_Click(object sender, EventArgs e)
        {
            ...
            if ((fname != "") & (lname != "") & (ciclul != "") & (special != "") & (notam != ""))
            {
                ...
                MySqlCommand command = new MySqlCommand("INSERT INTO `cerere_fil` (`nume`, `prenume`, `notamedie`, `facultatea`, `ciclu`, `specialitatea`) VALUES (@num, @pre, @nm, @fac, @cic, @spec);", db.getConnection());
        ...
        void getdataformSQL()
        {
            ...
            da.SelectCommand = new MySqlCommand("select * from cerere_fil ", db.getConnection());
