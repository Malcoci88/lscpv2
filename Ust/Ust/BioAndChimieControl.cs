...
namespace Ust
{
    public partial class BioAndChimieControl : UserControl
    {
        public BioAndChimieControl()
        {
            InitializeComponent();
        }
        ...
        private void bt_cerere_Click(object sender, EventArgs e)
        {
            ...
            if ((fname != "") & (lname != "") & (ciclul != "") & (special != "") & (notam != ""))
            {
                ...
                MySqlCommand command = new MySqlCommand("INSERT INTO `cerere_bio` (`nume`, `prenume`, `notamedie`, `facultatea`, `ciclu`, `specialitatea`) VALUES (@num, @pre, @nm, @fac, @cic, @spec);", db.getConnection());
            ...
            void getdataformSQL()
        {
            ...
            da.SelectCommand = new MySqlCommand("select * from cerere_bio ", db.getConnection());
