...
namespace Ust
{
    public partial class GeografieControl : UserControl
    {
        public GeografieControl()
        {
            InitializeComponent();
        }
        ...
        private void bt_cerere_Click(object sender, EventArgs e)
        {
            ...
            if ((fname != "") & (lname != "") & (ciclul != "") & (special != "") & (notam != ""))
            {
                ...
                MySqlCommand command = new MySqlCommand("INSERT INTO `cerere_geo` (`nume`, `prenume`, `notamedie`, `facultatea`, `ciclu`, `specialitatea`) VALUES (@num, @pre, @nm, @fac, @cic, @spec);", db.getConnection());
        ...
        void getdataformSQL()
        {
            ...
            da.SelectCommand = new MySqlCommand("select * from cerere_geo ", db.getConnection());
